...
<body>
    ...
    <div class="container">
        ...
        <img src="{{ asset('assets/images/Picture32.jpg') }}" alt="Gambar Header" class="img-fluid" style="width: 100vw; height: 350px; object-fit: cover; position: relative; left: calc(-50vw + 50%); margin-bottom: 20px;">
        <div class="container position-relative" style="top: -80px;">
        <h1 class="display-4 text-overlay mb-2" style="position: relative; background-color: rgba(255, 255, 255, 0.8); padding: 10px 20px; border-radius: 10px;">AKUNTANSI DAN KEUANGAN LEMBAGA</h1>
    </div>
</header>
    ...
    <div class="row">
        <div class="col-md-12 mb-4">
            <div class="card border-light rounded shadow-sm mb-4" style="background-color: #f8f9fa;">
                <!-- <div class="card-header text-white" style="background-color: #E9EFEC;"> -->
                    <h5 class="mb-0"></h5>
                </div>
                <div class="card-body">
                    <p class="text-muted">
                    SMK jurusan Akuntansi Keuangan dan Lembaga adalah salah satu program studi yang ditawarkan di Sekolah Menengah Kejuruan (SMK) yang bertujuan untuk mempersiapkan siswa dengan keterampilan dan pengetahuan dalam bidang akuntansi dan keuangan. Program studi ini biasanya menekankan pada pembelajaran praktis yang meliputi pengelolaan keuangan, pencatatan transaksi, pembuatan laporan keuangan, dan penggunaan perangkat lunak akuntansi.
                    </p>
                </div>
            </div>
            ...
            <div class="card-header text-white" style="background-color: #FFAD60;">
                    <h5 class="mb-0 text-white">Berikut adalah beberapa materi yang biasanya diajarkan dalam program studi SMK jurusan Akuntansi Keuangan Dan Lembaga:</h5>
                </div>
                <div class="card-body">
                    <ol class="list-unstyled">
                        <li>
                            <i class="bi bi-check-circle text-success"></i>
                            <strong>1. Dasar-dasar Akuntansi:</strong> Siswa mempelajari konsep dasar akuntansi, termasuk klasifikasi akun, pencatatan transaksi keuangan, penyusunan jurnal, dan penyusunan neraca. Mereka juga belajar tentang siklus akuntansi dan prosedur yang terkait dengan pembuatan laporan keuangan.
                            </li>
                        <li>
                            <i class="bi bi-check-circle text-success"></i>
                            <strong>2. Penggunaan Perangkat Lunak Akuntansi:</strong> Siswa diajarkan untuk menggunakan perangkat lunak akuntansi seperti MYOB, Zahir Accounting, atau perangkat lunak akuntansi lainnya. Mereka belajar tentang pengoperasian perangkat lunak akuntansi, pemrosesan transaksi, pembuatan laporan keuangan, dan analisis data keuangan.
                            </li>
                        <li>
                            <i class="bi bi-check-circle text-success"></i>
                            <strong>3. Analisis Laporan Keuangan :</strong> Siswa mempelajari tentang manajemen arsip dan pengarsipan dokumen. Mereka belajar tentang penyimpanan, pengindeksan, dan pemeliharaan arsip dalam lingkungan perkantoran.
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-4 d-flex justify-content-center">
            <div class="card shadow-sm border-light" style="width: 100%; display: flex; flex-direction: row; align-items: center;" data-aos="fade-up">
                <img src="{{ asset('assets/images/Picture48.jpg') }}" class="card-img-top" alt="Dokumentasi USK 1" style="width: 150px; height: 150px; object-fit: cover;">
                <div class="card-body">
                    <h5 class="card-title">Akuntansi</h5>
                    <p class="card-text text-muted">Uji Kompetensi Siswa dalam bidang akuntansi, di mana siswa belajar menyusun laporan keuangan dan memahami prinsip-prinsip akuntansi yang tepat.</p>
                 </div>
            </div>
        </div>
        ...
        <div class="col-md-6 mb-4 d-flex justify-content-center">
            <div class="card shadow-sm border-light" style="width: 100%; display: flex; flex-direction: row; align-items: center;" data-aos="fade-up">
                <img src="{{ asset('assets/images/usk3.jpg') }}" class="card-img-top" alt="Dokumentasi USK 2" style="width: 150px; height: 150px; object-fit: cover;">
                <div class="card-body">
                    <h5 class="card-title"> Analisis Laporan Keuangan </h5>
                    <p class="card-text text-muted">Uji Kompetensi Siswa dalam menganalisis laporan keuangan, di mana siswa belajar teknik analisis untuk mengevaluasi kinerja keuangan suatu entitas.</p>
                  </div>
            </div>
        </div>
    </div>
