...
<body>
    ...
    <img src="{{ asset('assets/images/Picture33.jpg') }}" alt="Gambar Header" class="img-fluid" style="width: 100vw; height: 350px; object-fit: cover; position: relative; left: calc(-50vw + 50%); margin-bottom: 20px;">
    <div class="container position-relative" style="top: -80px;">
        <h1 class="display-4 text-overlay mb-2" style="position: relative; background-color: rgba(255, 255, 255, 0.8); padding: 10px 20px; border-radius: 10px;">TEKNIK KOMPUTER DAN JARINGAN</h1>
    </div>
</header>
    ...
    <div class="row">
        <div class="col-md-12 mb-4">
            ...
            <div class="card border-light rounded shadow-sm mb-4" style="background-color: #f8f9fa;">
                ...
                <div class="card-body">
                    <p class="text-muted">
                    SMK jurusan Teknik Komputer dan Jaringan (TKJ) adalah salah satu program studi yang ditawarkan di Sekolah Menengah Kejuruan (SMK) yang bertujuan untuk mempersiapkan siswa dengan keterampilan dan pengetahuan dalam bidang teknologi komputer dan jaringan. Program studi ini menekankan pada pembelajaran praktis yang mencakup penguasaan perangkat keras komputer, instalasi jaringan, pemeliharaan sistem jaringan, serta pengelolaan dan pengamanan data.
                    </p>
                </div>
            </div>

            <!-- Card untuk Kompetensi Utama -->
            <div class="card border-light rounded shadow-sm mb-4" style="background-color: #f8f9fa;">
                <div class="card-header text-white" style="background-color: #FFAD60;">
                    <h5 class="mb-0 text-white">Berikut adalah beberapa materi yang biasanya diajarkan dalam program studi SMK jurusan Teknik Jaringan Dan Kabel:</h5>
                </div>
                <div class="card-body">
                    <ol class="list-unstyled">
                        <li>
                            <i class="bi bi-check-circle text-success"></i>
                            <strong>1. Dasar-dasar Jaringan Komputer:</strong> Siswa mempelajari konsep dasar jaringan komputer, termasuk topologi jaringan, protokol jaringan, perangkat keras jaringan seperti switch, router, dan kabel, serta cara instalasi jaringan lokal (LAN).
                            </li>
                        <li>
                            <i class="bi bi-check-circle text-success"></i>
                            <strong>2. Administrasi Jaringan:</strong> Siswa belajar tentang pengelolaan dan pemeliharaan jaringan, termasuk konfigurasi perangkat jaringan, pengelolaan server, keamanan jaringan, serta pemecahan masalah jaringan.
                            </li>
                        <li>
                            <i class="bi bi-check-circle text-success"></i>
                            <strong>3. Pemrograman Dasar untuk Jaringan:</strong> Siswa diperkenalkan kepada pemrograman yang terkait dengan jaringan, seperti scripting untuk otomatisasi jaringan, serta penggunaan bahasa pemrograman yang mendukung pengelolaan dan pengembangan sistem jaringan.
                        </li>
                            <!-- <i class="bi bi-check-circle text-success"></i>
                            <strong>4. Akuntansi Keuangan:</strong> Siswa belajar tentang laporan keuangan, neraca, dan laporan laba rugi.
                        </li>  -->
                    </ol>
                </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-4 d-flex justify-content-center">
            <div class="card shadow-sm border-light" style="width: 100%; display: flex; flex-direction: row; align-items: center;" data-aos="fade-up">
                <img src="{{ asset('assets/images/Picture46.jpg') }}" class="card-img-top" alt="Dokumentasi USK 1" style="width: 150px; height: 150px; object-fit: cover;">
                <div class="card-body">
                    <h5 class="card-title">Jaringan Komputer</h5>
                    <p class="card-text text-muted">Uji Kompetensi Siswa dalam bidang jaringan komputer, di mana siswa melakukan perakitan dan pengaturan jaringan komputer dengan teknik yang tepat.</p>
                 </div>
            </div>
        </div>
        ...
        <div class="col-md-6 mb-4 d-flex justify-content-center">
            <div class="card shadow-sm border-light" style="width: 100%; display: flex; flex-direction: row; align-items: center;" data-aos="fade-up">
                <img src="{{ asset('assets/images/Picture47.jpg') }}" class="card-img-top" alt="Dokumentasi USK 2" style="width: 150px; height: 150px; object-fit: cover;">
                <div class="card-body">
                    <h5 class="card-title">Pemrograman Dasar </h5>
                    <p class="card-text text-muted">Uji Kompetensi Siswa dalam bidang pemrograman dasar, di mana siswa belajar mengembangkan aplikasi sederhana menggunakan bahasa pemrograman yang sesuai.</p>
                </div>
            </div>
        </div>
    </div>
